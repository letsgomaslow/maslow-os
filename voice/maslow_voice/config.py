...
DEFAULTS = {
    ...
    "realtime_model": "gpt-realtime-2.1", "livekit_url": "",
...
def validate_settings(settings: dict) -> dict:
    ...
    for key, choices in {"mode": {"offline", "server", "livekit", "openai"}, "server_kind": {"ollama", "lmstudio"}, "default_coder": {"codex", "claude", "hermes"}}.items():
