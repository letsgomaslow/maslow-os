    ...
    class GeminiAgent(type(base)):
        def __init__(self):
            agents.Agent.__init__(self, instructions=(
                ...
                "and new_project only when they explicitly request a new project. Never invent paths. "
                "Use task_control for progress, corrections, cancellation, continuation or results of the current job. "
                "Corrections belong to the existing job, not a new task. Approvals must be answered in the task view. "
