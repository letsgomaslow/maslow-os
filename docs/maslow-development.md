...
Updated 2026-09-14. This is the current workstream index, not a stable-release announcement. Update this file at each meaningful checkpoint; keep detailed evidence in dated handoffs rather than expanding AGENTS.md into a second backlog.

Current GPT-Live delivery work: [Hub 0.3.2 / exact Voice 0.1.4-9 Lenovo test update](handoffs/2026-09-14-gpt-live-lenovo-test-release.md), authorized by the user after the documentation closeout. Hub and its installed OTA/Voice-update rehearsal passed, including preserved state and native voice selection. The separate fresh Mac synthetic GPT-Live check passed after a tester-only cache fix. Operator signing, immutable package publication and staging sequence 5 promotion are complete at public distribution `f605c57fa2927a44e218d795845e920e31aca2e9`; anonymous download and metadata verification passed at 21:58:46 UTC. The next action is Lenovo update and GPT-Live user acceptance. No ISO rebuild is needed.
...
Current delivery checkpoint: [GPT-Live Lenovo test release](handoffs/2026-09-14-gpt-live-lenovo-test-release.md) is published and anonymously verified as Hub 0.3.2 / staging sequence 5, superseding the frozen 0.3.1 candidate for this test. The exact 0.3.0 package remains available for Hub rollback. User-reported Lenovo arrival applies to the earlier 0.3.0 release; arrival and acceptance of 0.3.2 remain open. LiveKit remains pending. A3 physical Lenovo recovery and F1 Observability backend/trace acceptance remain open; physical Voice audio and complete orb interaction are separate gates. R1/R2 remain recommendations, and security design S1 still blocks any promise of agent-hidden secrets.
