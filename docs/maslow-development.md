...
Current Voice checkpoint: [Voice accomplishments, GPT-Live evidence, RCAs and pending work](handoffs/2026-09-14-voice-checkpoint.md). **LiveKit is PENDING at the user's request.** Its source and evidence are preserved; do not continue the older echo experiment or prepare a Lenovo update from the previous recovery handoff. This checkpoint is documentation-only.
