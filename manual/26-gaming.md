...
Maslow OS supports gaming as well as focused work. Its optional install routes include Steam and RetroArch for native and retro play; Battle.net, Lutris, and Heroic for non-Steam stores; Moonlight for PC streaming; Xbox Cloud Gaming and NVIDIA GeForce NOW for cloud play; and Minecraft.
...
All gaming installers live under _Install > Gaming_ in the Maslow OS menu (`Super + Space`). If you ever want to undo one, use _Remove > Gaming_.

## Steam

Install [Steam](https://store.steampowered.com/) by selecting _Install > Gaming > Steam_ from the Maslow OS menu (`Super + Space`).
...
Install [RetroArch](https://www.retroarch.com/) by selecting _Install > Gaming > RetroArch_ from the Maslow OS menu (`Super + Space`). It comes with the full set of libretro cores, so all the classic systems are covered.
...
Install the Xbox Cloud Gaming web app by selecting _Install > Gaming > Xbox Cloud Gaming_ from the Maslow OS menu (`Super + Space`). It's "just" a web app for the service, but it's quick to start and runs great at 1080p.
...
Install the cloud-gaming service [NVIDIA GeForce NOW](https://www.nvidia.com/en-us/geforce-now/) by selecting _Install > Gaming > NVIDIA GeForce NOW_ from the Maslow OS menu (`Super + Space`). Another great way to play titles that aren't available natively on Linux.

 ![gaming-geforce-now](images/gaming-geforce-now.webp)

## Minecraft

Install Minecraft by selecting _Install > Gaming > Minecraft_ from the Maslow OS menu (`Super + Space`).
...
Install support for Bluetooth Xbox controllers by selecting _Install > Gaming > Xbox Controllers_ from the Maslow OS menu (`Super + Space`). Pair the controllers via Bluetooth (`Super + Ctrl + B`) and they'll work in all your games. You don't need this if you're just hardwiring your controller with a USB-C cable.
...
Install [Battle.net](https://eu.shop.battle.net/en-us) by selecting _Install > Gaming > Battle.net_ from the Maslow OS menu (`Super + Space`). This gives you titles like Diablo, Starcraft, and World of Warcraft as a standalone install running under GE-Proton — no Steam, Lutris, or Heroic needed.

 ![gaming-starcraft](images/gaming-starcraft.webp)

## Lutris (Windows games)

Install [Lutris](https://lutris.net/) by selecting _Install > Gaming > Lutris_ from the Maslow OS menu (`Super + Space`). Lutris is the way to play Windows games from stores like EA and Ubisoft Connect that don't have their own installer above.
